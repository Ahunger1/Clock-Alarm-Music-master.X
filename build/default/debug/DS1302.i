...
# 8 "DS1302.c"
const int *week[7] = {"Mon.", "Tue.", "Wed.", "Thu.", "Fri.", "Sat.", "Sun."};
...
unsigned char SET_TIME[7] = {0x55, 0x59, 0x23, 0x15, 0x03, 0x07, 0x20};

signed char aHOUR_ten, aHOUR_unit, aMINUTE_ten, aMINUTE_unit, aSECOND_ten, aSECOND_unit;

unsigned char tempTime_Ds1302[7];

unsigned char LcdTimeAddr[13] = {3, 4, 6, 7, 9, 10, 14, 6, 7, 9, 10, 12, 13};
...
LCD_write_char(3, 1, YEAR_ten + '0');
LCD_write_char(4, 1, YEAR_unit + '0');
LCD_write_char(6, 1, MONTH_ten + '0');
LCD_write_char(7, 1, MONTH_unit + '0');
LCD_write_char(9, 1, DAY_ten + '0');
LCD_write_char(10, 1, DAY_unit + '0');
LCD_write_string(13 - 1, 1, week[WEEK_unit - 1]);



LCD_write_char(6, 2, HOUR_ten + '0');
LCD_write_char(7, 2, HOUR_unit + '0');
LCD_write_char(9, 2, MINUTE_ten + '0');
LCD_write_char(10, 2, MINUTE_unit + '0');
LCD_write_char(12, 2, SECOND_ten + '0');
LCD_write_char(13, 2, SECOND_unit + '0');
}



void FrameworkDisplay(void) {
LCD_write_char(4 + 1, 1, '-');
LCD_write_char(7 + 1, 1, '-');
LCD_write_char(7 + 1, 2, ':');
LCD_write_char(10 + 1, 2, ':');
}
...
void AlarmDataDisplay(void) {
LCD_write_char(6, 2, aHOUR_ten + '0');
LCD_write_char(7, 2, aHOUR_unit + '0');
LCD_write_char(9, 2, aMINUTE_ten + '0');
LCD_write_char(10, 2, aMINUTE_unit + '0');
LCD_write_char(12, 2, aSECOND_ten + '0');
LCD_write_char(13, 2, aSECOND_unit + '0');
}
