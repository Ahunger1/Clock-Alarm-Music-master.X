...
LCD_write_string(3, 1, "MUSIC");
LCD_write_string(0, 2, "NUM:");
MusicPosition = 0;
} else {
if (Mode == 0 || Mode == 1) {
FrameworkDisplay();
...
aFrameworkDisplay();
LCD_write_string(1, 1, "SETTING--ALARM");
}
}
clear_flag = 0;
}
...
LCD_write_string(LcdTimeAddr[cursor_addr], Y_position(cursor_addr), "_");
delay_ms(96);
switch (cursor_addr) {
case 0:
{
...
AlarmDataDisplay();
delay_ms(78);
LCD_write_string(LcdTimeAddr[cursor_addr + 7], 2, "_");
delay_ms(98);
